...
<script type="text/javascript">
			function addProduct(){
				window.location.href = "${pageContext.request.contextPath}/addListUI";
			}
			function delProduct(pid) {
				var isDel=confirm("您是否确定删除");
				if (isDel){
				    window.location.href="${pageContext.request.contextPath}/delList?pid="+pid;
				}
            }
